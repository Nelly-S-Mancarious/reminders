...
class RemindersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reminder" do
    assert_difference('Reminder.count') do
      post reminders_url, params: { reminder: { day_time: @reminder.day_time, description: @reminder.description, month_day: @reminder.month_day, title: @reminder.title, user_id: @reminder.user_id } }
    end
  ...
  test "should update reminder" do
    patch reminder_url(@reminder), params: { reminder: { day_time: @reminder.day_time, description: @reminder.description, month_day: @reminder.month_day, title: @reminder.title, user_id: @reminder.user_id } }
